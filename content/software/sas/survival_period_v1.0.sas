...
libname colon 'c:\rsmodel\sas_colon\';
options fmtsearch=(colon work library) orientation=landscape pageno=1 ls=157 ps=45;
...
title4 'Standard errors calculated (incorrectly) using the actuarial method';
by &vars;
pageby &lastvar;
