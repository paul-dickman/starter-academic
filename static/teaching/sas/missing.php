<?PHP
$strPageStyle = 'main';
$strTitle = 'Missing values in SAS';
require ('config.php');
require ('header.php');
...
run;</pre>
    ...
    <pre>if age &lt; 20 then agecat=1;
else if age &lt; 50 then agecat=2;
else if age ge 50 then agecat=3;
else if age=. then agecat=9;

Since missing values are considered smaller than all numbers, records with age=. will be coded to agecat=1.</pre>
