...
// 4. If you only have rates up to, e.g., 2010 and need rates for later
...
infile _year _age female male total using "death_rates_Sweden_2010_from_mortality_org.txt" if (_year > 1949 & _age < 100), clear
drop total
rename male rate1
rename female rate2
...
compress
save popmort_sweden_2010, replace
